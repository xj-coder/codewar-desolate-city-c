...
public class IndexUI extends JFrame {
	...
	private void initComponents() {
		...
		getLayeredPane().add(getPlayer_info_urllabel(),
				new Integer(Integer.MIN_VALUE));
		...
		// 左侧目录树[按钮]
		getLayeredPane().add(getDir_lock_button(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_unlock_button(),
				new Integer(Integer.MIN_VALUE));

		// 左侧目录树[背景]
		getLayeredPane().add(getDir_search_bg_left_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_search_bg_center_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_search_bg_right_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_up_left_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_up_center_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_up_right_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_left_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_center_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_right_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_down_left_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_down_center_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getDir_bg_down_right_label(),
				new Integer(Integer.MIN_VALUE));
	...
	public JLabel getDir_bg_up_left_label() {
		if (dir_bg_up_left_label == null) {
			dir_bg_up_left_label = new JLabel(new ImageIcon(ImageFactory
	...
	public JLabel getDir_bg_up_center_label() {
		if (dir_bg_up_center_label == null) {
			dir_bg_up_center_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirBgUpCenterImage().getScaledInstance(284, 58,
							Image.SCALE_DEFAULT)));
			resetDir_bg_up_center_label();
		}
	...
	public JLabel getDir_bg_up_right_label() {
		if (dir_bg_up_right_label == null) {
			dir_bg_up_right_label = new JLabel(new ImageIcon(ImageFactory
	...
	public JLabel getDir_bg_left_label() {
		if (dir_bg_left_label == null) {
			dir_bg_left_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirBgLeftImage().getScaledInstance(13,
							getHeight() - 100 - 15 - 12, Image.SCALE_DEFAULT)));
			resetDir_bg_left_label();
		}
	...
	public void resetDir_bg_left_label() {
		getDir_bg_left_label().setBounds(5, 115, 13,
				getHeight() - 100 - 15 - 12);
	}

	public JLabel getDir_bg_center_label() {
		if (dir_bg_center_label == null) {
			dir_bg_center_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirBgCenterImage().getScaledInstance(314 - 24,
							getHeight() - 100 - 58 - 12, Image.SCALE_DEFAULT)));
			resetDir_bg_center_label();
		}
	...
	public void resetDir_bg_center_label() {
		getDir_bg_center_label().setBounds(18, 158, 314 - 24,
				getHeight() - 100 - 58 - 12);
	}

	public JLabel getDir_bg_right_label() {
		if (dir_bg_right_label == null) {
			dir_bg_right_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirBgRightImage().getScaledInstance(13,
							getHeight() - 100 - 15 - 12, Image.SCALE_DEFAULT)));
			resetDir_bg_right_label();
		}
	...
	public void resetDir_bg_right_label() {
		getDir_bg_right_label().setBounds(301, 115, 13,
				getHeight() - 100 - 15 - 12);
	}

	public JLabel getDir_bg_down_left_label() {
		if (dir_bg_down_left_label == null) {
			dir_bg_down_left_label = new JLabel(new ImageIcon(ImageFactory
	...
	public JLabel getDir_bg_down_center_label() {
		if (dir_bg_down_center_label == null) {
			dir_bg_down_center_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirBgDownCenterImage().getScaledInstance(314 - 24,
							12, Image.SCALE_DEFAULT)));
			resetDir_bg_down_center_label();
		}
	...
	public void resetDir_bg_down_center_label() {
		getDir_bg_down_center_label().setBounds(12, getHeight() - 12 - 5,
				314 - 24, 12);
	}

	public JLabel getDir_bg_down_right_label() {
		if (dir_bg_down_right_label == null) {
			dir_bg_down_right_label = new JLabel(new ImageIcon(ImageFactory
	...
	public void resetDir_bg_down_right_label() {
		getDir_bg_down_right_label().setBounds(302, getHeight() - 12 - 5, 12,
				12);
	}

	public JLabel getDir_search_bg_left_label() {
		if (dir_search_bg_left_label == null) {
			dir_search_bg_left_label = new JLabel(new ImageIcon(ImageFactory
	...
	public void resetDir_search_bg_left_label() {
		getDir_search_bg_left_label().setBounds(10, 127, 26, 27);
	}

	public JLabel getDir_search_bg_center_label() {
		if (dir_search_bg_center_label == null) {
			dir_search_bg_center_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirSearchBgCenterImage().getScaledInstance(
							314 - 26 - 10 - 15, 27, Image.SCALE_DEFAULT)));
	...
	public void resetDir_search_bg_center_label() {
		getDir_search_bg_center_label().setBounds(26 + 10, 128,
				314 - 10 - 26 - 15, 25);
	}

	public JLabel getDir_search_bg_right_label() {
		if (dir_search_bg_right_label == null) {
			dir_search_bg_right_label = new JLabel(new ImageIcon(ImageFactory
	...
	public void resetDir_search_bg_right_label() {
		getDir_search_bg_right_label().setBounds(314 - 18, 127, 15, 25);
	}

	public JLabel getDir_list_bg_up_left_label() {
		if (dir_list_bg_up_left_label == null) {
			dir_list_bg_up_left_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirListBgUpLeftImage().getScaledInstance(16, 16,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getDir_list_bg_up_center_label() {
		if (dir_list_bg_up_center_label == null) {
			dir_list_bg_up_center_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirListBgUpCenterImage().getScaledInstance(16, 16,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getDir_list_bg_up_right_label() {
		if (dir_list_bg_up_right_label == null) {
			dir_list_bg_up_right_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirListBgUpRightImage().getScaledInstance(16, 16,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getDir_list_bg_left_label() {
		if (dir_list_bg_left_label == null) {
			dir_list_bg_left_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirListBgLeftImage().getScaledInstance(16, 16,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getDir_list_bg_right_label() {
		if (dir_list_bg_right_label == null) {
			dir_list_bg_right_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirListBgRightImage().getScaledInstance(16, 16,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getDir_list_bg_down_left_label() {
		if (dir_list_bg_down_left_label == null) {
			dir_list_bg_down_left_label = new JLabel(new ImageIcon(ImageFactory
					.getIndexDirListBgDownLeftImage().getScaledInstance(16, 16,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getDir_list_bg_down_center_label() {
		if (dir_list_bg_down_center_label == null) {
			dir_list_bg_down_center_label = new JLabel(new ImageIcon(
					ImageFactory.getIndexDirListBgDownCenterImage()
	...
	public JLabel getDir_list_bg_down_right_label() {
		if (dir_list_bg_down_right_label == null) {
			dir_list_bg_down_right_label = new JLabel(new ImageIcon(
					ImageFactory.getIndexDirListBgDownRightImage()
							.getScaledInstance(16, 16, Image.SCALE_DEFAULT)));
	...
	public void resetPlayer_info_urllabel() {
		FontMetrics fontMetrics = getPlayer_info_urllabel().getFontMetrics(
				Define.DEFAULT_FONT);
		int _width = fontMetrics.stringWidth(getPlayer_info_urllabel()
				.getShow_text());

		getPlayer_info_urllabel().setBounds(
	...
	public JButton getSearch_list_button() {
		if (search_list_button == null) {
			search_list_button = WidgetFactory.createIndexSearchListButton(40,
					14, "", IndexParams.ACTION_SEARCH_LIST, actionAdapter);
	...
	public JButton getSearch_enter_button() {
		if (search_enter_button == null) {
			search_enter_button = WidgetFactory.createIndexSearchEnterButton(
					40, 14, "", IndexParams.ACTION_SEARCH_ENTER, actionAdapter);
	...
	public JButton getDir_lock_button() {
		if (dir_lock_button == null) {
			dir_lock_button = WidgetFactory.createIndexDirLockButton(18, 17,
					"", IndexParams.ACTION_DIR_LOCK, actionAdapter);
	...
	public void resetDir_lock_button() {
		getDir_lock_button().setBounds(314 - 20, 105, 18, 17);
	}
	...
	public JButton getDir_unlock_button() {
		if (dir_unlock_button == null) {
			dir_unlock_button = WidgetFactory.createIndexDirUnLockButton(18,
					17, "", IndexParams.ACTION_DIR_UNLOCK, actionAdapter);
	...
	public void resetDir_unlock_button() {
		getDir_unlock_button().setBounds(314 - 20, 105, 18, 17);
	}
