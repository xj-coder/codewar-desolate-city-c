...
public class LoginUI extends JFrame {
	...
	private final LoginActionAdapter actionAdapter = new LoginActionAdapter(
			this);
	...
	private void initComponents() {
		...
		setLocation(Tools.getScreenSize().width / 2 - getWidth() / 2,
				(int) (Tools.getScreenSize().getHeight() / 2 - getHeight() / 2));
		...
		getLayeredPane().add(getLogin_processbar_out_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getLogin_processbar_in_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getLogin_processbar_bg(),
				new Integer(Integer.MIN_VALUE));

		getLayeredPane().add(getInfo_label(), new Integer(Integer.MIN_VALUE));
		getLayeredPane()
				.add(getAccount_label(), new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getPassword_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane()
				.add(getAccount_input(), new Integer(Integer.MIN_VALUE));
		...
		getLayeredPane().add(getArticleUrlLabel(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getGetBackPasswordUrlLabel(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane().add(getRegisterAccountUrlLabel(),
				new Integer(Integer.MIN_VALUE));
		...
		getLayeredPane().add(getPassword_input(),
				new Integer(Integer.MIN_VALUE));
		...
		getLayeredPane().add(getBg_center_label(),
				new Integer(Integer.MIN_VALUE));
		getLayeredPane()
				.add(getBg_down_label(), new Integer(Integer.MIN_VALUE));
	...
	public JLabel getBg_up_label() {
		if (bg_up_label == null) {
			bg_up_label = new JLabel(new ImageIcon(ImageFactory
					.getLoginBgUpImage().getScaledInstance(355, 130,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getBg_center_label() {
		if (bg_center_label == null) {
			bg_center_label = new JLabel(new ImageIcon(ImageFactory
					.getLoginBgCenterImage().getScaledInstance(355, 40,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getBg_down_label() {
		if (bg_down_label == null) {
			bg_down_label = new JLabel(new ImageIcon(ImageFactory
					.getLoginBgDownImage().getScaledInstance(355, 70,
							Image.SCALE_DEFAULT)));
	...
	public JButton getHelp_button() {
		if (help_button == null) {
			help_button = WidgetFactory.createHelpButton(21, 22, "",
					LoginParams.ACTION_HELP, actionAdapter);
	...
	public JButton getLogin_button() {
		if (login_button == null) {
			login_button = WidgetFactory.createButton(70, 25,
					LoginParams.NAME_LOGIN, LoginParams.ACTION_LOGIN,
					actionAdapter);
	...
	public JButton getSet_button() {
		if (set_button == null) {
			set_button = WidgetFactory.createButton(70, 25,
					LoginParams.NAME_SETTING, LoginParams.ACTION_SETTING,
					actionAdapter);
	...
	public JLabel getBanner_label() {
		if (banner_label == null) {
			banner_label = new JLabel(new ImageIcon(ImageFactory
					.getLoginBannerImage().getScaledInstance(351, 70,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getLogin_processbar_in_label() {
		if (login_processbar_in_label == null) {
			login_processbar_in_label = new JLabel(new ImageIcon(ImageFactory
					.getLoginProcessbarInImage().getScaledInstance(75, 4,
							Image.SCALE_DEFAULT)));
			login_processbar_in_label.setBounds((int) Math.random()
					* (355 - 75), 95, 75, 4);
		}
	...
	public JLabel getLogin_processbar_out_label() {
		if (login_processbar_out_label == null) {
			login_processbar_out_label = new JLabel(new ImageIcon(ImageFactory
					.getLoginProcessbarOutImage().getScaledInstance(355, 4,
							Image.SCALE_DEFAULT)));
	...
	public JLabel getLogin_processbar_bg() {
		if (login_processbar_bg == null) {
			login_processbar_bg = new JLabel(new ImageIcon(ImageFactory
					.getLoginProcessbarBgImage().getScaledInstance(355, 4,
							Image.SCALE_SMOOTH)));
	...
	public JCheckBox getMemory_check() {
		if (memory_check == null) {
			memory_check = new JCheckBox("记住密码");
			memory_check.setFont(Define.DEFAULT_FONT);
	...
	public JCheckBox getHide_check() {
		if (hide_check == null) {
			hide_check = new JCheckBox("隐身登录");
			hide_check.setFont(Define.DEFAULT_FONT);
	...
	public JCheckBox getAgree_check() {
		if (agree_check == null) {
			...
			agree_check.setFont(Define.DEFAULT_FONT);
	...
	public URLLabel getRegisterAccountUrlLabel() {
		if (registerAccountUrlLabel == null) {
			registerAccountUrlLabel = new URLLabel("申请账号");
			registerAccountUrlLabel.setFont(Define.DEFAULT_FONT);
	...
	public URLLabel getGetBackPasswordUrlLabel() {
		if (getBackPasswordUrlLabel == null) {
			getBackPasswordUrlLabel = new URLLabel("忘了密码？");
			getBackPasswordUrlLabel.setFont(Define.DEFAULT_FONT);
	...
	public URLLabel getArticleUrlLabel() {
		if (articleUrlLabel == null) {
			articleUrlLabel = new URLLabel("同意条款");
			articleUrlLabel.setFont(Define.DEFAULT_FONT);
	...
	public void showMe() {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				AWTUtilities.setWindowShape(LoginUI.this,
				...
				try {
					...
					while (true) {
						if (isLoginProcessStart) {
							Thread.sleep(8);
							x = (getLogin_processbar_in_label().getX() + 1)
									% (LoginUIDefine.FRAME_WIDTH - getLogin_processbar_in_label()
											.getWidth());
