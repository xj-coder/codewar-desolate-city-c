...
public class ImageFactory {
	...
	public static Image getIndexSearchListButton() {
		URL url = ImageFactory.class.getClassLoader().getResource("image/index/DirTree/s-list.png");
	...
	public static Image getIndexSearchEnterButton() {
		URL url = ImageFactory.class.getClassLoader().getResource("image/index/DirTree/s-enter.png");
	...
	public static Image getIndexDirLockButton() {
		URL url = ImageFactory.class.getClassLoader().getResource("image/index/DirTree/lock.png");
	...
	public static Image getIndexDirLockButtonPressed() {
		URL url = ImageFactory.class.getClassLoader().getResource("image/index/DirTree/unlock.png");
		return ImageTools.cut(url, 0, 0, 18, 17, "png");
	}
	...
	public static Image getIndexLeftSplitterButton() {
		URL url = ImageFactory.class.getClassLoader().getResource("image/common/splitter/left.png");
	...
	public static Image getIndexRightSplitterButton() {
		URL url = ImageFactory.class.getClassLoader().getResource("image/common/splitter/right.png");
		return ImageTools.cut(url, 0, 0, 9, 80, "png");
	}
