 ...
 * draw() method.
 */
public abstract class FullCore {

	protected static final int FONT_SIZE = 24;

	private static final DisplayMode POSSIBLE_MODES[] = { new DisplayMode(800, 600, 16, 0), new DisplayMode(800, 600, 32, 0), new DisplayMode(800, 600, 24, 0),
			new DisplayMode(640, 480, 16, 0), new DisplayMode(640, 480, 32, 0), new DisplayMode(640, 480, 24, 0), new DisplayMode(1024, 768, 16, 0),
	...
	public void init() {
		...
		isRunning = true;
		frame.setCursor(Toolkit.getDefaultToolkit().createCustomCursor(ResourceManager.loadImage("cur.png"), new Point(0, 0), "cur"));
