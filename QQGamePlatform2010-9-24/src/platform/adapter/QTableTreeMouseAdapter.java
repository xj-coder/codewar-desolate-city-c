...
public class QTableTreeMouseAdapter extends MouseAdapter {
	...
	public void mouseClicked(MouseEvent e) {
		...
		QTableTreeItem item = (QTableTreeItem) tableTreeUI.getModel()
				.getElementAt(index);
	...
	public void mouseExited(MouseEvent e) {
		...
		((QTableTreeItem) tableTreeUI.getModel().getElementAt(oldIndex))
				.setRollover(false);
	...
	public void mouseMoved(MouseEvent e) {
		...
		((QTableTreeItem) tableTreeUI.getModel().getElementAt(index))
				.setRollover(true);
		oldIndex = index;
