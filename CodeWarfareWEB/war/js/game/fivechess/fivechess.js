DCC.game.FiveChess=Ext.extend(Ext.app.GameModule,{
	...
	setCellPanelInnerHTML : function(cell){    //为cell设置背景
		var temp=cell.getAttribute("id").replace(/[^\d]/g,'');
		cell.innerHTML="<img src='images/fivechess/m.jpg'>";				//从普遍到特殊
	...
	isAnyoneWin : function(cell,flag){  //判断输赢的方法	
